...
-- 2026-09-12 去重后 OfflineQueue 用 require('zy_shell') 载入同目录正本。本 fixture 故意把
-- ZIYAN_LUA 指向不存在的运行时来模拟 embed 场景，所以这里显式给出模块目录。
package.path=arg[4]..'/lua/modules/?.lua;'..package.path
